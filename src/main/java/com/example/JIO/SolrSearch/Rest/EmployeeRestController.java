...
public class EmployeeRestController {
    ...
    public void loadData() {
        ...
        Employee e = new Employee.MyBuilder().id(random.longs(23).toString()).firstName("keshav").lastName("joshi").emailId("keshav@gmail.com").skills(skill_set1).process().mybuild();
        Employees.add(e);
        ...
        Employee e1 = new Employee.MyBuilder().id(random.doubles().toString()).firstName("rishikesh").lastName("mohanty").emailId("abc@gmail.com").skills(skill_set2).process().mybuild();
        Employees.add(e1);
